...
/**
 * Assistant Component
 * A floating technical companion with character-by-character streaming support.
 */
    ...
    initialMessages: [
      {
        id: "welcome",
        role: "assistant",
        content: "Hello! I'm the Lumina Assistant. I've analyzed our library of architectural reports and guides. How can I help you today?"
      }
    ]
  });
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <span className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest">Active Insight</span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-6">
                ...
                {isLoading && messages[messages.length - 1]?.role !== "assistant" && (
                  <div className="flex gap-3 animate-in fade-in duration-300">
                    ...
                    <div className="bg-muted/50 border border-border/50 rounded-2xl rounded-tl-none px-4 py-2 flex items-center gap-1.5">
                ...
                {error && (
                  <p className="text-[10px] text-center font-bold text-destructive uppercase tracking-widest bg-destructive/10 py-2 rounded-lg">
                    Connectivity Interrupted. Try again.
                  </p>
                )}
              </div>
            </ScrollArea>
